...
| 2 | 1 | 4 | left = 3`[5]`, right = 4 `[1]` | 3 | swap index 1 and 3 | `[10, 5, 8, 4, 1, 2, 7]` |
| 3 | 3 | 4 | left = 7, right = 9 | 3 | none |  `[10, 5, 8, 4, 1, 2, 7]` |
...
A Max‑Heap always places the largest element at the root.
Heapsort swaps that maximum into the end of the array, building a sorted suffix from right to left.
Repeating this produces an ascending array.

A Min‑Heap always places the smallest element at the root.
Swapping the minimum into the end places the smallest element at the rightmost position first, producing a descending array.
